...
from src.schemas.users import UsersSchema, FinalUserSchema, UserAddSchema, UserFilterSchema
...
class UserService(BService):
    ...
    async def update_user(self, data: UsersSchema, user_id: int) -> FinalUserSchema:
